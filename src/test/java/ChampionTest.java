...
public class ChampionTest {
    ...
    public void givenCollectionWhenEmptyCorrect() {
        ...
        assertFalse(!emptyList.isEmpty()); //김도연
    ...
    public void testForRelatedString() {
        ...
        assertFalse(!sampleString1.contains(startString)); //김도연
        assertFalse(!sampleString2.contains(endString)); //김도연
        assertFalse(!(sampleString1.contains(startString) || sampleString2.contains(endString))); //김도연
    ...
    public void testForFloatingPoint() {
        assertThat(3.14, closeTo(3, 1)); //김도연
...
//        assertThat(3.14,closeTo(3.1,0.04));             //최지원
    ...
    public void shouldHaveSomeChampName() {
        ...
        assertThat(champListNames.get(1), hasToString("애쉬")); //김도연
    ...
    public void shouldTopChampionIsDarius() {
        ...
        assertFalse(!champName.equals("다리우스")); //김도연
