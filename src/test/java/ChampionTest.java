...
//        assertThat("다리우스", is(champName));
    ...
    public void shouldSameInstance(){ //원동욱
        ...
        assertThat(testList, instanceOf(championList.getClass())); //동일한 인스턴스인지 타입을 비교한다.
        assertThat("리신", sameInstance(championList.get(1).getName())); //Object가 완전히 동일한지를 비교한다.
        //equals 비교가 아닌 주소비교로 작동
    }

    @Test
    public void shouldIgnoringWhiteSpace() { //원동욱
        assertThat(championList.get(2).getPosition(), equalToIgnoringWhiteSpace("      미드       "));
        //문자열의 앞뒤의 공백만을 무시한다.
    }
}