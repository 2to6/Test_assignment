...
//        assertThat(3.14,closeTo(3.1,0.04));             //최지원
    ...
    public void shouldHaveSomeChampName() {
        List<String> champListNames = Arrays.asList("조이", "티모", "아이번", "애쉬", "징크스", "카밀");  //최지원
    ...
    public void shouldHaveSamePropertyAndValue() {
        List<String> championNames1 = Arrays.asList("루시안", "애쉬", "렉사이", "갈리오", "모르가나", "블라디미르");  //최지원
        List<String> championNames2 = Arrays.asList("루시안", "애쉬", "렉사이", "갈리오", "모르가", "블라디미르");    //최지원
